...
- the MFD module alias: `mfd_rv8803` to `mfd_zest_rtc_rv8803_X`
- the RTC module alias: `rtc_rv8803` to `rtc_zest_rtc_rv8803_X`
- the counter module alias: `counter_rv8803` to `counter_zest_rtc_rv8803_X`
- the clock controller alias: `clock_rv8803` to `clock_zest_rtc_rv8803_X`
